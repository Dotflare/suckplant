...
namespace SuckplantMod.Modules
{
    internal static class Tokens
    {
        ...
        {
            #region Suckplant
            string prefix = SuckplantPlugin.DEVELOPER_PREFIX + "_Suckplant_BODY_";

            string desc = "Suckplant is a skilled fighter who makes use of a wide arsenal of weaponry to take down his foes.<color=#CCD3E0>" + Environment.NewLine + Environment.NewLine;
            ...
            LanguageAPI.Add(prefix + "NAME", "Suckplant");
            ...
            #region Passive
            LanguageAPI.Add(prefix + "PASSIVE_NAME", "Suckplant passive");
            ...
            #region Achievements
            LanguageAPI.Add(prefix + "MASTERYUNLOCKABLE_ACHIEVEMENT_NAME", "Suckplant: Mastery");
            LanguageAPI.Add(prefix + "MASTERYUNLOCKABLE_ACHIEVEMENT_DESC", "As Suckplant, beat the game or obliterate on Monsoon.");
            LanguageAPI.Add(prefix + "MASTERYUNLOCKABLE_UNLOCKABLE_NAME", "Suckplant: Mastery");
            #endregion
            #endregion
        }
    }
